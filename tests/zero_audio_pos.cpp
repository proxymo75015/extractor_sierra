...
TEST_CASE("Zero audio position is skipped") {
  fs::path tmpDir = fs::temp_directory_path();
  fs::path input = tmpDir / "zero_audio_pos.rbt";
  fs::path outDir = tmpDir / "zero_audio_pos_out";
  ...
  auto wavOdd = outDir / "frame_00001_odd.wav";
